  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="http://localhost/PHP-Project/docs/HomeAdmin.php">Home</a></li>
        
        <li><a href="http://localhost/PHP-Project/docs/All_Products.php"> Products </a></li>
        <li><a href="http://localhost/PHP-Project/docs/All_Users.php"> Users </a></li>
        <li><a href="http://localhost/PHP-Project/docs/admin_order.php"> Manual Orders </a></li>
        <li><a href="http://localhost/PHP-Project/docs/Checks.php"> Checks </a></li>
